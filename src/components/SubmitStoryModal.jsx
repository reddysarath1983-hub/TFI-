...
export default function SubmitStoryModal({ onClose, onSubmitStory }) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/85 backdrop-blur-md flex items-center justify-center p-3 sm:p-4 overflow-y-auto animate-fadeIn">
      <div className="relative w-full max-w-2xl glass-panel rounded-2xl border border-[#E5A93C]/40 gold-glow p-5 sm:p-8 space-y-5 max-h-[92vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
            <div className="space-y-1">
              ...
              <input
                ...
                className="w-full bg-[#121218] border border-[#27272A] rounded-xl p-2.5 sm:p-3 text-xs text-slate-200 focus:outline-none focus:border-[#E5A93C]"
              />
            </div>
          ...
          {/* Dream Cast Setup */}
          <div className="bg-[#09090B]/60 p-3.5 sm:p-4 rounded-xl border border-[#27272A] space-y-2.5">
          ...
          <div className="space-y-1">
            ...
            <textarea
              ...
              className="w-full bg-[#121218] border border-[#27272A] rounded-xl p-2.5 text-xs font-script text-slate-200 focus:outline-none focus:border-[#E5A93C]"
            />
          </div>
